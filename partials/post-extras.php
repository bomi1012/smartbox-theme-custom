...
<div class="post-extras">
    ...
    <?php comments_popup_link( _x(__('No comments', THEME_FRONT_TD), 'comments number', THEME_FRONT_TD ), _x( __('1 comment', THEME_FRONT_TD), 'comments number', THEME_FRONT_TD ), _x( __('% comments', THEME_FRONT_TD), 'comments number', THEME_FRONT_TD ) ); ?>
    <?php endif; ?>
</div>
